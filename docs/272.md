...
When I write tensorflow even logs into my wandb directory (sample code in http://github.com/lukas/models in tutorials/image/cifar10/cifar10_train.py.
